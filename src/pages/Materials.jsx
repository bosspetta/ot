        ...
        <section className="page-content">
            ...
            <header className="page-header page-header--english-groups page-header--one-to-one">
                <div className="page-header__data">
                    ...
                    <div className="page-header__data__call-to-action">
                        ...
                        <a target="_blank" rel="noreferrer" href="https://www.academia.oscartrejo.online/home" className="page-header__link btn">{t("materials.btn")}</a>
                    </div>
                </div>
            </header>
            <section className="cta cta--eng-groups cta--eng-groups--materials">
                <div className="cta__wrapper">
                    ...
                    <div className="cta__btn-wrapper">
                        <a target="_blank" rel="noreferrer" href="https://www.academia.oscartrejo.online/home" className="btn">{t("materials.benefits.btn")}</a>
                    </div>
                </div>
            </section>
            <section className="cta cta--price cta--price--materials">
                <div className="cta__wrapper">
                    ...
                    <div className="cta__btn-wrapper">
                        <a target="_blank" rel="noreferrer" href="https://www.academia.oscartrejo.online/home" className="btn">{t("materials.examples.btn")}</a>
                    </div>
                </div>
            </section>
            ...
            <section className="cta cta--oscar cta--materials">
                <div className="cta__wrapper">
                    <div className="container">
                        ...
                        <div className="cta__btn-wrapper">
                            <a target="_blank" rel="noreferrer" href="https://www.academia.oscartrejo.online/home" className="btn">{t("materials.academy.btn")}</a>
                        </div>
                    </div>
                </div>
            </section>
