            ...
            <h1 className="site-title">
                <Link to="/" className="site-title__home-link" title="Ir al inicio">
                    ...
                    <span className="site-title__naming">
                        <span className="site-title__subtitle">Estudio de <strong>Yoga</strong> y <strong>Quiromasaje</strong></span>
                        <span className="site-title__yoga-teacher"><strong>Isabel</strong> Martínez San Esteban</span>
                    </span>
                </Link>
            </h1>
            <h2 className="opening--subtitle">¡Próxima apertura!</h2>
            <p>Abriré las puertas el próximo <strong>1 de septiembre de 2023</strong>. Ven, estaré encantada de ayudarte.</p>
        </div>
    )
}
